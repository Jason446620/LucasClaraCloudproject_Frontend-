...
import CardRegisterNewHiredService from '../../../components/HiredService/cardRegisterNewHiredService';
import ModalWarning from '../../../components/Generic/modalWarning';

export default function RegisterNewHiredService() {
        ...
        <div>
            ...
            <div className="hiredServiceBody">
                <div className="hiredServiceInternalBody">
                    <CardRegisterNewHiredService nameClient={nameClient} />
                </div>
            </div>
            {
