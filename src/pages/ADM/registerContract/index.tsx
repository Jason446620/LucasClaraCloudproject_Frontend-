...
//import components
import CardRegisterContract from '../../../components/Contract/cardRegisterContract';
...
export default function RegisterContract() {
    ...
    return (
        <div>
            <SideMenu />
            <div className="registerContractBody">
                <div className="registerContractInternalBody">
                    <CardRegisterContract nameClient={nameClient} />
                </div>
            </div>
            {
