...
interface CardRegisterNewHiredServiceProps {
    nameClient: string;
}

const CardRegisterNewHiredService: React.FC<CardRegisterNewHiredServiceProps> = ({ nameClient }) => {
        ...
        if (idSku !== '0') {
            fetch('http://localhost5000/api/HiredServiceProduct', {
                ...
                .catch(err => {
                    setIsModalWarningVisible(true);
                    setIsReload(true);
                    setModalTitle('Houve um erro ao cadastrar este serviço contratado!');
                    console.error(err);
                });
        }
        else {
            setIsModalWarningVisible(true);
            setModalTitle('Informe o SKU do serviço para efetuar o cadastro');
        }
    }
    ...
    return (
        <div>
            <form className="cardNewHiredServiceCorpo" onSubmit={event => {
                ...
                <div className="cardNewHiredServiceInput">
                    ...
                    <div className='cardNewHiredServiceInputSeparatorLeft'>
                        ...
                        <div className='cardNewHiredServiceInputSeparator'>
                ...
                <div className="cardNewHiredServiceButton">
                    <div className="cardNewHiredServiceButtonSeparator">
...
export default CardRegisterNewHiredService;